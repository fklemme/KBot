...
/// Abstraction of a base. (depot, minerals, workers...)
class Base {
...
public:
    ...
    /// method does not transfer the unit's ownership so takeOwnership() has to be called
    /// explicitly.
...
private:
    ...
    /// Returns the amount of workers this base should add to be saturated. TODO: Move this
    /// function? DEBUG only?
